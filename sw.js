...
const urlsToCache = [
  ...
  '/day90nailsart/vendor/react.production.min.js',
  '/day90nailsart/vendor/react-dom.production.min.js',
  '/day90nailsart/vendor/babel.min.js',
  '/day90nailsart/vendor/bcrypt.min.js',
  '/day90nailsart/vendor/tailwind-browser.js',
  '/day90nailsart/vendor/lucide/lucide.css',
  '/day90nailsart/vendor/lucide/lucide.woff2',
  '/day90nailsart/utils/push-config.js',
  '/day90nailsart/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/day90nailsart/icons/icon-192x192.png',
    badge: '/day90nailsart/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/day90nailsart/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/day90nailsart/admin.html';
  event.waitUntil(
